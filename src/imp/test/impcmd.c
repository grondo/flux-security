...
int main (void)
{
    ...
    ok ((cmd = imp_cmd_find_child ("version")) != NULL,
        "imp_cmd_find_child finds 'version' cmd");
    ok ((cmd = imp_cmd_find_parent ("version")) == NULL,
        "imp_cmd_find_parent: NULL for 'version' subcommand");
